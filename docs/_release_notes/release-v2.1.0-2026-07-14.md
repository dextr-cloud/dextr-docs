...
We will be deploying release 2.1 on July 15th at 5am EDT. The release will be available in the beta environment ([https://beta.connectpath.cx](https://beta.connectpath.cx)) starting on July 7th (some items may not be available until the 8th). As always, we highly recommend and appreciate it if you could have some users take production calls from the Beta environment to ensure there are no issues prior to the release.
