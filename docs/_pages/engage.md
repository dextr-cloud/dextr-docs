...
{% include figure image_path="/assets/images/call-hold.gif" alt="Call on Hold" caption="Gif 1. Making calls through Dialpad"%}
...
{% include figure image_path="/assets/images/transfer-call.gif" alt="Call Transfer" caption="Gif 2. Call Transfer"%}

[![Conference Call](/assets/images/conference-call.jpg)](/assets/images/conference-call.jpg)

Figure 2. Conference Call
...
{% include figure image_path="/assets/images/call-disposition.gif" alt="Call Disposition" caption="Gif 3. Call Disposition"%}
